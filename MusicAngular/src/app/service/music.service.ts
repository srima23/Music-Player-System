...
export class MusicService {
  ...
  addSongToPlaylist(playlistId: number, songId: number): Observable<string> {
    return this.http.post<string>(`${this.baseURL}/${playlistId}/add-song/${songId}`, {}, { headers: this.getHeaders() });
  }
  ...
  getSongsByLibraryId(libraryId: number): Observable<any[]> {
    return this.http.get<any[]>(`${this.baseURL}/${libraryId}/songs`, { headers: this.getHeaders() });
  }
